...
public partial class Comprobante
{
    ...
    public string QR
    {
        get
        {
            ...
            string sQR = "";
            string baseQR = "";
            qr = ApplicationXMLtoPDF.Services.QR.createBarCode("https://verificacfdi.facturaelectronica.sat.gob.mx/default.aspx?id=" + TimbreFiscalDigital.UUID + "&re=" + Emisor.Rfc + "&fe=" + Receptor.Rfc + "&tt=" + Total + "&fe=" + Sello.Substring(Sello.Length - 9, 8));
    ...
    public string MonedaLetra
    {
        get
        {
            ApplicationXMLtoPDF.Services.Moneda oMoneda = new ApplicationXMLtoPDF.Services.Moneda();
